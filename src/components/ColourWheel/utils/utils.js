...
export function calculateBounds(min, max) {
  ...
  return {
    ...
    inside: (cursorPosFromCenter) => cursorPosFromCenter >= min && cursorPosFromCenter <= max,
  };
}
...
// Method for generating a radius representative of the stroke + taking into account lineWidth.
